...
export default function Home() {
  return (
    <div className="max-w-6xl">
      ...
      {/* Hero Section */}
      <div className="bg-iara-verde-base text-iara-branco rounded-2xl p-8 md:p-12 mb-12 relative overflow-hidden">
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-6">
            <IaraIcon className="w-16 h-16" />
            <div>
              <h2 className="font-display text-3xl font-bold">IARA</h2>
              <p className="text-iara-verde-accent font-display">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {sections.map((section) => (
          <Link
            key={section.title}
            href={section.href}
            className="group block p-6 rounded-xl border border-foreground/10 
      ...
      <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6">
        <div className="text-center p-6 rounded-xl bg-muted">
          <div className="font-display text-3xl font-bold text-iara-verde-accent">
            2
          </div>
        ...
        <div className="text-center p-6 rounded-xl bg-muted">
          ...
          <div className="text-sm text-muted-foreground">Cores Principais</div>
        </div>
        <div className="text-center p-6 rounded-xl bg-muted">
          <div className="font-display text-3xl font-bold text-iara-verde-accent">
            2
